...
namespace RemoteReading.Core
{
	...
	public partial class UserContact 
	{
        ...
        public UserContact(string realname, string mobilephone, string email)
        {
            this.m_PersonName = realname;
            this.m_MobilePhone = mobilephone;
            this.m_Email = email;
        }
        public UserContact(string realname, string mobilephone, string email, EProfessionTitle title, int hospID)
        {
            this.m_PersonName = realname;
            this.m_MobilePhone = mobilephone;
            this.m_Email = email;
            this.m_ProfessionTitle = title;
            this.m_HospitalID = hospID;
        }
        #endregion
		...
		#region IsExpert
		private System.Boolean m_IsExpert = false ; 
		...
		#region ProfessionTitle
        private EProfessionTitle m_ProfessionTitle = (EProfessionTitle)(-1); 
		public EProfessionTitle ProfessionTitle
		{
			get
			{
				return this.m_ProfessionTitle ;
			}
			set
			{
				this.m_ProfessionTitle = value ;
			}
		}
		#endregion
        ...
        #region SYS_CreatedByUserID
        private string m_SYS_CreatedByUserID ;
        public string SYS_CreatedByUserID
        {
            get
            {
                return this.m_SYS_CreatedByUserID;
            }
            set
            {
                this.m_SYS_CreatedByUserID = value;
            }
        }
        #endregion
	
		#region HospitalID
		private System.Int32 m_HospitalID =-1 ; 
		public System.Int32 HospitalID
		{
			get
			{
