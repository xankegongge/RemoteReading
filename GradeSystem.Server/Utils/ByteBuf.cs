...
namespace GradeSystem.Server
{
    ...
    public class ByteBuf : Stream
    {
        ...
        public ByteBuf(MemoryStream stream)
        {
            _stream = stream;
            ClearBookmark();
        }
        ...
        public void Put(ByteBuf src, int count)
        {
        ...
        */
        ...
        /// <returns></returns>
        public static int Put(ByteBuf output, ByteBuf input, int numBytesMax)
        {
