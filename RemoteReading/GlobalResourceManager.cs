    ...
    internal class GlobalResourceManager
    {
        ...
        public static void PreInitialize()
        {
            try
            {
                ...
                GlobalResourceManager.noneIcon64 = global::RemoteReading.Properties.Resources.None64;
                GlobalResourceManager.medicalReadingIcon = ImageHelper.ConvertToIcon(global::RemoteReading.Properties.Resources.阅片, 64);
                GlobalResourceManager.medicalReadingImage = Image.FromFile(AppDomain.CurrentDomain.BaseDirectory + "Resource\\medicalreading.png" );
                GlobalResourceManager.groupIcon = ImageHelper.ConvertToIcon(global::RemoteReading.Properties.Resources.normal_group_40, 64);
        ...
        #region SoftwareName
        private static string softwareName = "远程阅片系统";
        ...
        public static string[] DyedMethods ={
                                                 "革兰染色"
                                                 ,"抗酸染色"
                                                 ,"荧光染色"
                                                 ,"瑞式染色"
        ...
        #endregion
        private static Icon medicalReadingIcon=null;
        private static Image medicalReadingImage = null;
        public static Image GetMedicalReadingImage()
        {

            return GlobalResourceManager.medicalReadingImage;
        }
        public static Icon GetMedicalReadingIcon()
        {
            return GlobalResourceManager.medicalReadingIcon;
        }
    }
}
