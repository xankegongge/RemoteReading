...
namespace RemoteReading
{
    ...
    {
        public static string SystemSettingsDir = Environment.GetFolderPath(Environment.SpecialFolder.Personal) + "\\RemoteReadingdat\\" ;
        ...
        #region MainFormSize
        private Size mainFormSize = new Size(396, 756);
        /// <summary>
        /// 主窗体的大小
        /// </summary>
        public Size MainFormSize
        {
            get 
            {
                ...
                {
                    this.mainFormSize = new Size(396, 756);
                }
                return mainFormSize; 
            }
